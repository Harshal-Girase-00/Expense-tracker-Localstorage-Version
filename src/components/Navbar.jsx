...
const Navbar = () => {
  ...
  return (
    <div className="flex md:justify-between h-20 w-full md:px-20 bg-white shadow-md items-center ">
      <button
        className="sm:w-1/3 ml-4 sm:ml-0 mr-8 sm:mr-0 md:hidden text-3xl"
      ...
      <div className="flex gap-2 items-center">
        <img src="/images/logo.webp" alt="logo" className="w-16" />
        <p className="font-bold">EXPENSE TRACKER</p>
      </div>

      <ul
        className={`flex-col md:flex-row absolute md:static left-0 top-20  md:w-auto sm:bg-white bg-gray-100 md:flex rounded-xl md:py-0 transition-all duration-300 ${
      ...
      >
        ...
        <li className="md:border-r-2 border-black px-4  md:px-2 font-medium">
          <Link onClick={() => setMenuOpen(!menuOpen)} to="/about">
            About
          </Link>
        </li>
